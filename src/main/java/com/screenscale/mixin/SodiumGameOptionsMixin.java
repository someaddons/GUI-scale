...
public class SodiumGameOptionsMixin
{
    ...
    @Redirect(method = "general", at = @At(value = "INVOKE", target = "Lme/jellysquid/mods/sodium/client/gui/options/OptionGroup$Builder;build()Lme/jellysquid/mods/sodium/client/gui/options/OptionGroup;", ordinal = 1), remap = false, require = 0)
